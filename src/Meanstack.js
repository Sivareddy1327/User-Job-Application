...
import Modal from 'react-modal'
    ...
    const Meanstack = (props) =>{ 
        ...
        const MeanstackData = backenddata.filter((ele)=>{
    ...
    const handleClick = (id) =>{
        const result = MeanstackData.find((ele)=>{
            if(ele._id == id) 
                {
                    return ele
                }
    ...
    return (
        <div>
            ...
            <h3>List of Candidates applied for MEAN Stack Developer</h3>
