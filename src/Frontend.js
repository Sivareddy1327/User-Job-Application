...
const Frontend = (props) =>{
    ...
    const FrontendData = backenddata.filter((ele)=>{
    ...
    const handleClick = (id) =>{
        const result = FrontendData.find((ele)=>{
            if(ele._id == id) 
                {
                    return ele
                }
    ...
    return (
        <div style={{textAlign : 'center'}}>
            ...
            <h3>List of Candidates applied for Front-End Developer</h3>
